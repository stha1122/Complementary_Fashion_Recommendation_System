...
class FashionProductSTLDataloader:
    ...
    def data_loader(self):
        ...
        return DataLoader(dataset, batch_size=cfg.BATCH_SIZE, shuffle=False, num_workers=1)
...
class FashionCompleteTheLookDataloader:
    def __init__(self, image_type="train", batch_size=cfg.BATCH_SIZE, num_workers=1):
